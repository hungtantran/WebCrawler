...
public class URLPrioritizerProvider implements IURLPrioritizer, IURLPrioritizerProvider {
	private static Logger LOG = LogManager.getLogger(URLPrioritizerProvider.class.getName());
	...
	public IURLPrioritizer newURLPrioritizer() {
		return new URLPrioritizerProvider();
	}
}
