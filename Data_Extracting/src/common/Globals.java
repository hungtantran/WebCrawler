...
public class Globals {
    ...
    public static String extractedTextTableName = "extracted_text_table";
    public static String cleanExtractedTextTableName =
            "clean_extracted_text_table";
    public static String dictionaryTableName = "dictionary_table";
    public static String rawhtmlTableName = "rawhtml_table";

    // public static final CharArraySet STOPWORDS = StandardAnalyzer
    // .STOP_WORDS_SET;
    public static final CharArraySet STOPWORDS = new CharArraySet(new
            ...
            "are", "aren", "arent", "arise", "around", "as", "aside", "ask",
            ...
            "gave", "get",
            "gets", "getting", "give", "given", "gives", "giving", "go",
            "goes", "gone", "got", "gotten", "h", "had", "happens", "hardly",
            "has", "hasn't", "have", "haven't", "having", "he", "hed",
            "hence", "her",
            ...
            "id", "ie", "if",
            "i'll", "im", "immediate", "immediately", "importance",
            ...
            "meantime", "meanwhile", "merely",
            "mg", "might", "million", "miss", "ml", "more", "moreover",
            "most", "mostly", "mr", "mrs", "much", "mug", "must", "my",
            "myself", "n", "na", "name", "namely", "nay", "nd", "near",
            "nearly", "necessarily",
            ...
            "seven", "several",
            "shall", "she", "shed", "she'll", "shes", "should", "shouldn't",
            ...
            "thus", "til",
            "tip", "to", "together", "too", "took", "toward", "towards",
            ...
            "vs", "w", "want",
            "wants", "was", "wasnt", "way", "we", "wed", "welcome", "we'll",
            "went", "were", "werent", "we've", "what", "whatever", "what'll",
            "whats", "when", "whence", "whenever", "where", "whereafter",
            "whereas",
            ...
            "whose", "why", "widely",
            "will", "willing", "wish", "with", "within", "without", "wont",
            "words", "world", "would", "wouldnt", "www", "x", "y", "yes",
            "yet", "you", "youd", "you'll", "your", "youre", "yours",
            "yourself", "yourselves",
