...
public class LinkTypeDAOJDBC implements LinkTypeDAO {
    private static Logger LOG = LogManager.getLogger(LinkTypeDAOJDBC.class
            .getName());

    private final String SQL_SELECT_ALL = "SELECT * FROM link_type_table";
    private final String SQL_INSERT = "INSERT INTO link_type_table (id, type)" +
			" values (?, ?)";
    ...
    private LinkType constructLinkTypeObject(ResultSet resultSet) throws
			SQLException {
    ...
    public List<LinkType> get() throws SQLException {
        ...
        try {
            ...
            while (resultSet.next()) {
                final LinkType linkType = this.constructLinkTypeObject
						(resultSet);
